import { IonButton, IonButtons, IonCheckbox, IonContent, IonHeader, IonIcon, IonItem, IonModal, IonText, IonTitle, IonToolbar, IonCardContent } from '@ionic/react'
...
const TermsModal: React.FC<{ isOpen: boolean, onDidDismiss: () => void, termsAccepted: boolean, settermsAccepted: (val: boolean) => void }> = ({ isOpen, onDidDismiss, termsAccepted, settermsAccepted }) => {
    return (
        <IonModal isOpen={isOpen} onDidDismiss={onDidDismiss}>
            <IonHeader>
                <IonToolbar> <IonTitle>Terms and Conditions</IonTitle>
                    <IonButtons onClick={onDidDismiss} slot='end'>
                        <IonButton >
            ...
            <IonContent  >
                <div className="ion-padding" style={{ padding: '20px' }}>
                    ...
                    <ul>
                        <li>
                            <p><strong>Application</strong> means the software program provided by the Company downloaded by You on any electronic device, named NovaFriends</p>
                        </li>
                        <li>
                        ...
                        <li>
                            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to NovaFriends.</p>
                        </li>
                        <li>
                    ...
                    <p>If You are a copyright owner, or authorized on behalf of one, and You believe that the copyrighted work has been copied in a way that constitutes copyright infringement that is taking place through the Service, You must submit Your notice in writing to the attention of our copyright agent via email at support@novafriends.io and include in Your notice a detailed description of the alleged infringement.</p>
                    ...
                    <p>You can contact our copyright agent via email at support@novafriends.io.
                    ...
                    <ul>
                        <li>By email: <a target='__blank' href='mailto:support@novafriends.io'>support@novafriends.io</a> </li>
                    </ul>
                    <br />
                    <br />
                ...
                <IonItem>
                    <IonCheckbox className='checkmark' checked={termsAccepted} color='tertiary' onIonChange={(e) => settermsAccepted(e.detail.checked)} slot='start'></IonCheckbox>
                    <IonText>I agree to the terms and conditions stated above</IonText>
                </IonItem>
                <IonCardContent className='terms--footer'>
                    <IonButton onClick={onDidDismiss} disabled={!termsAccepted} className='terms--button'>Next</IonButton>
                </IonCardContent>
            </IonContent>
